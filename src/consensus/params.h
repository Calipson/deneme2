...
public:
    ...
    virtual CAmount MinDenemeCoinAmount(unsigned nHeight) const = 0;
...
public:
    ...
    CAmount MinDenemeCoinAmount(unsigned nHeight) const
    {
        if (nHeight < 212500)
            return 0;
...
public:
    ...
    CAmount MinDenemeCoinAmount(unsigned) const
    {
        return COIN / 100;
    }
