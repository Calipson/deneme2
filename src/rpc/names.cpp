...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    { "denemecoin",           "name_show",              &name_show,              false,  {"name"} },
    { "denemecoin",           "name_history",           &name_history,           false,  {"name"} },
    { "denemecoin",           "name_scan",              &name_scan,              false,  {"start","count"} },
    { "denemecoin",           "name_filter",            &name_filter,            false,  {"regexp","maxage","from","nb","stat"} },
    { "denemecoin",           "name_pending",           &name_pending,           true,   {"name"} },
    { "denemecoin",           "name_checkdb",           &name_checkdb,           false,  {} },
};
