...
/**
 * Build genesis block for testnet.  In denemecoin, it has a changed timestamp
...
public:
    CMainParams() {
        ...
        // The value is the chain work of the denemecoin mainnet chain at height
        ...
        vSeeds.push_back(CDNSSeedData("digi-masters.com", "denemecoindnsseed.digi-masters.com"));
        vSeeds.push_back(CDNSSeedData("digi-masters.uk", "denemecoindnsseed.digi-masters.uk"));
        vSeeds.push_back(CDNSSeedData("quisquis.de", "nmc.seed.quisquis.de"));
        vSeeds.push_back(CDNSSeedData("webbtc.com", "dnsseed.denemecoin.webbtc.com"));
        ...
        /* See also doc/denemecoinBugs.txt for more explanation on the
           historical bugs added below.  */

        /* These transactions have name outputs but a non-denemecoin tx version.
           They contain NAME_NEWs, which are fine, and also NAME_FIRSTUPDATE.
           The latter are not interpreted by denemecoind, thus also ignore
           them for us here.  */
        ...
        /* These are non-denemecoin tx that contain just NAME_NEWs.  Those were
           ...
           "ignore" them, as their outputs need no special denemecoin handling
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        // The value is the chain work of the denemecoin testnet chain at height
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("webbtc.com", "dnsseed.test.denemecoin.webbtc.com"));
