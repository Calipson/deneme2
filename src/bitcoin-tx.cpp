...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s denemecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  denemecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded denemecoin transaction") + "\n" +
              "  denemecoin-tx [options] -create [commands]   " + _("Create hex-encoded denemecoin transaction") + "\n" +
              "\n";
