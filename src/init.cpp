...
void Shutdown()
{
    ...
    RenameThread("denemecoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/calipson/denemecoin-core>";
    const std::string URL_WEBSITE = "<https://denemecoin.org/>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("denemecoin-loadblk");
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("denemecoin version %s\n", FormatFullVersion());
}
